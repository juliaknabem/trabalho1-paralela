//https://github.com/adricarda/parallel-Bucket-Sort/blob/master/parallelBucketSort/parallelBucketSort.c
#include <omp.h>
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
int main(int argc, char *argv[]) {
    ...
    // Defina a lista de números previamente definida
    int predefined_numbers[] = {1, 3, 6, 9, 2, 8};
    dim = sizeof(predefined_numbers) / sizeof(predefined_numbers[0]);
    n_buckets = 4; // Defina o número de buckets desejado
    ...
    // Use a lista de números previamente definida
    A = (int *)malloc(sizeof(int) * dim);
    B = (int *)malloc(sizeof(int) * dim);

    for (i = 0; i < dim; i++) {
        A[i] = predefined_numbers[i];
    }
